...
describe("Trick", () => {
  it("returns shuffled deck with 21 cards", () => {
    const trickDeck = getShuffledTrickDeck();
    expect(trickDeck.length).toBe(21);
    expect(trickDeck).not.toStrictEqual(INITIAL_TRICK_DECK_CARDS.slice(0, 21));
  });
